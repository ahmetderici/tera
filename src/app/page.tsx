  ...
  return (
    <main className="relative bg-black text-white overflow-hidden min-h-screen">
      ...
      <nav className="flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        ...
        <a href="#demo" className="bg-white text-black px-5 py-2 rounded-md font-medium hover:bg-gray-200 transition">
          Request a Demo
        </a>
      </nav>
      ...
      <section className="flex flex-col items-center text-center px-6 py-24 lg:py-36 max-w-4xl mx-auto">
        ...
        <p className="mt-6 text-lg text-gray-300 max-w-2xl">
          Tera helps Texas schools generate legally compliant FIE evaluations in hours — not days. Trusted by diagnosticians. Powered by AI.
        </p>
        <div className="mt-8 flex flex-col sm:flex-row gap-4">
          <a href="#demo" className="bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500 text-white font-semibold px-6 py-3 rounded-md shadow-lg hover:scale-105 transition">
            Request a Demo
          </a>
          <a href="#how" className="border border-white text-white font-semibold px-6 py-3 rounded-md hover:bg-white hover:text-black transition">
            Learn More
          </a>
        </div>
      </section>
      ...
      <section className="mt-32 max-w-3xl mx-auto text-center px-4">
        ...
        <p className="text-gray-400 text-lg leading-relaxed">
          A Full Individual and Initial Evaluation (FIE) is a federally mandated assessment for special education eligibility. Tera transforms the complex process into a streamlined, AI-assisted experience.
        </p>
      </section>
